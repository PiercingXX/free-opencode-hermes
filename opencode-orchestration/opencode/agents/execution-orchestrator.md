...
description: Overnight single-lane builder for Free OpenCode. One session, one routing chain. Owns the loop on disk until done. Runs on the pinned local lane by default.
mode: primary
