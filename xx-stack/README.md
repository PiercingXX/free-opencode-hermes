...
> Vendored core of [Free OpenCode](../README.md). Standalone
> [xx-stack](https://github.com/PiercingXX/xx-stack) flattened this tree to its
> git root in 1.66. This repo keeps it nested so it does not collide with
> `packages/plugin/` and the root installers. Clone-path examples below are
> written for standalone xx-stack; here the same files live under `xx-stack/`.
