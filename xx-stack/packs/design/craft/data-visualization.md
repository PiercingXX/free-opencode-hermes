...
> and the six-check procedure are a widely used dataviz-skill method,
> re-derived here rather than copied — see "Provenance" at the foot of
> this file.
...
the three-slot all-pairs cap are a widely used dataviz-skill method,
read at a published bundle version `2.1.232`.
