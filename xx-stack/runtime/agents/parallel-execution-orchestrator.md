...
description: Overnight multi-lane builder for Free OpenCode. Fans independent slices across available free/cloud models and extra hosts. GPU/self-hosted last. No step cap. Tab this when the work splits cleanly.
mode: primary
temperature: 0
permission:
  edit: allow
