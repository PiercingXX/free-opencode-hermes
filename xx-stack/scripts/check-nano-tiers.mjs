...
// Nested Free OpenCode layout keeps xx-stack/ under the git root; standalone
// xx-stack flattens it. inventory.example.json always sits at the git root.
const gitRoot = fs.existsSync(path.join(componentRoot, "inventory.example.json"))
  ? componentRoot
  : path.resolve(componentRoot, "..");
const opencodeRoot = path.join(gitRoot, "opencode-orchestration", "opencode");
...
const SURFACES = [
  {
    ...
    canonicalSha256: "ca1b38ef0175cd2318749f89f15ecab363a2cd59144a4806f138c1c437f51424",
  },
  {
    id: "fast-build",
    kind: "agent",
